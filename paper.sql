...
-- ----------------------------
-- Table structure for pap_banner
-- ----------------------------
DROP TABLE IF EXISTS `pap_banner`;
CREATE TABLE `pap_banner`  (
...
-- ----------------------------
-- Records of pap_banner
-- ----------------------------
INSERT INTO `pap_banner` VALUES ('1', 'test3', 'https://imageView2/2/w/560/format/webp', '/customer', 3, 0, '2021-04-13 18:05:32', '2021-04-18 10:28:22');
INSERT INTO `pap_banner` VALUES ('1194607458461216769', 'test2', 'https://upload-images.jianshu.io/upload_images/13291551-4f0b788202ec8d1a.png?imageMogr2/auto-orient/strip|imageView2/2/w/657/format/webp', '/customer', 2, 0, '2021-04-13 21:26:27', '2021-04-14 09:12:15');
INSERT INTO `pap_banner` VALUES ('1384026797275365378', 'string', 'string', 'string', 0, 0, '2021-04-19 14:11:17', '2021-04-19 14:11:17');

-- ----------------------------
-- Table structure for pap_customer
-- ----------------------------
DROP TABLE IF EXISTS `pap_customer`;
CREATE TABLE `pap_customer`  (
  `id` char(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '客户ID',
  `name` varchar(20) CHARACTER SET utf32 COLLATE utf32_general_ci NULL DEFAULT NULL COMMENT '客户昵称',
  `email` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '邮箱',
  `password` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '密码',
  `level` int(1) UNSIGNED ZEROFILL NOT NULL COMMENT '身份 1普通用户 2VIP会员',
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '客户头像',
  `sort` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序',
  `is_deleted` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '更新时间',
...
-- ----------------------------
-- Records of pap_customer
-- ----------------------------
INSERT INTO `pap_customer` VALUES ('1380858202162831362', '1', '1', '1', 1, '#', 1, 0, '2021-04-10 20:20:25', '2021-04-10 20:20:25');
INSERT INTO `pap_customer` VALUES ('1380861904860807170', 'a', 'd', 'd', 1, '#', 0, 0, '2021-04-10 20:35:08', '2021-04-10 20:35:08');
INSERT INTO `pap_customer` VALUES ('1380862525949149185', 's', 'd', 's', 1, '#', 0, 0, '2021-04-10 20:37:36', '2021-04-14 17:26:54');
INSERT INTO `pap_customer` VALUES ('1380880235005337601', 'd', 's', 'd', 1, '#', 0, 1, '2021-04-10 21:47:58', '2021-04-10 21:47:58');
INSERT INTO `pap_customer` VALUES ('1382269308113010690', 'ddfa', 'd', 's', 1, '#', 0, 0, '2021-04-14 17:47:39', '2021-04-14 17:47:39');
INSERT INTO `pap_customer` VALUES ('1382269413687836673', 'dgadg', 'ddgae', 'dgadg', 1, '#', 0, 0, '2021-04-14 17:48:04', '2021-04-14 17:48:04');
INSERT INTO `pap_customer` VALUES ('1382659517180571650', '哈哈', '更好用5个发给各个', '256位', 1, '#', 0, 0, '2021-04-15 19:38:12', '2021-04-17 20:11:02');
INSERT INTO `pap_customer` VALUES ('1383396833321037825', '123', '123', '123', 1, '#', 1, 0, '2021-04-17 20:28:02', '2021-04-17 20:41:18');
INSERT INTO `pap_customer` VALUES ('1383400657985220609', 'zhangsan', '123456@qq.com', '123456', 1, '#', 0, 0, '2021-04-17 20:43:14', '2021-04-17 20:43:14');
INSERT INTO `pap_customer` VALUES ('1383401989794181121', '张三', '123@qq.com', '123', 1, '#', 0, 1, '2021-04-17 20:48:31', '2021-04-17 20:48:31');
INSERT INTO `pap_customer` VALUES ('1383704778637893634', 'user', 'user@user.com', 'user', 1, '#', 0, 0, '2021-04-18 16:51:42', '2021-04-18 16:51:42');
INSERT INTO `pap_customer` VALUES ('1383748880226123777', '1234567', '1234567@163.com', '1234567', 1, '#', 0, 0, '2021-04-18 19:46:57', '2021-04-18 19:46:57');
INSERT INTO `pap_customer` VALUES ('1384136929619496962', '123456', '123456@126.com', '123456', 1, 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', 0, 0, '2021-04-19 21:28:55', '2021-04-19 21:28:55');
INSERT INTO `pap_customer` VALUES ('1384139287669805057', '123456@jxnu.edu.cn', '123456@jxnu.com', '123456', 1, '#', 0, 0, '2021-04-19 21:38:17', '2021-04-19 21:38:17');
INSERT INTO `pap_customer` VALUES ('1384139876168429570', '11223', '11224@jxnu.com', '123456', 1, '#', 0, 0, '2021-04-19 21:40:37', '2021-04-19 21:40:37');
INSERT INTO `pap_customer` VALUES ('1384218204397170690', '8888@88.com', '8888@88.com', '123456', 1, 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', 0, 0, '2021-04-20 02:51:52', '2021-04-20 02:51:52');
INSERT INTO `pap_customer` VALUES ('1384239177435574274', '1123', '1123@1123.com', '1123', 1, NULL, 0, 0, '2021-04-20 04:15:12', '2021-04-20 04:15:12');
INSERT INTO `pap_customer` VALUES ('1384242717537144834', '2333', '2333@2333.com', '2333', 1, 'http://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoj0hHXhgJNOTSOFsS 4uZs8x1ConecaVOB8eIl115xmJZcT4oCicvia7wMEufibKtTLqiaJeanU2Lpg3w/132', 0, 0, '2021-04-20 04:29:17', '2021-04-20 04:29:17');
